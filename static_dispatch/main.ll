...
@alloc_b5dc9e9c0d1f37556deb4441a21cb9e6 = private unnamed_addr constant <{ [5 x i8] }> <{ [5 x i8] c"Area:" }>, align 1
@alloc_49a1e817e911805af64bbc7efb390101 = private unnamed_addr constant <{ [1 x i8] }> <{ [1 x i8] c"\0A" }>, align 1
@alloc_110d1bd43e86ee08011d1bd9cd3082dd = private unnamed_addr constant <{ ptr, [8 x i8], ptr, [8 x i8] }> <{ ptr @alloc_b5dc9e9c0d1f37556deb4441a21cb9e6, [8 x i8] c"\05\00\00\00\00\00\00\00", ptr @alloc_49a1e817e911805af64bbc7efb390101, [8 x i8] c"\01\00\00\00\00\00\00\00" }>, align 8
@alloc_cc61dc4de52e355ec88897851528a503 = private unnamed_addr constant <{ [10 x i8] }> <{ [10 x i8] c"Perimeter:" }>, align 1
@alloc_513c709e935092212a5e01b086c380ac = private unnamed_addr constant <{ ptr, [8 x i8], ptr, [8 x i8] }> <{ ptr @alloc_cc61dc4de52e355ec88897851528a503, [8 x i8] c"\0A\00\00\00\00\00\00\00", ptr @alloc_49a1e817e911805af64bbc7efb390101, [8 x i8] c"\01\00\00\00\00\00\00\00" }>, align 8
...
; call std::io::stdio::_print
  ...
  store float 0x4028E66660000000, ptr %r1, align 4
  %0 = getelementptr inbounds i8, ptr %r1, i64 4
  store float 0x402AE66660000000, ptr %0, align 4
; call main::print_area_perimeter
  call void @_ZN4main20print_area_perimeter17hb087485c8d74b2d5E(ptr align 4 %r1)
  store float 0x402E47AE20000000, ptr %s1, align 4
; call main::print_area_perimeter
  call void @_ZN4main20print_area_perimeter17h9c728ea1d9ec0846E(ptr align 4 %s1)
  ret void
}

; <main::Rect as main::IShape>::area
; Function Attrs: uwtable
define internal float @"_ZN43_$LT$main..Rect$u20$as$u20$main..IShape$GT$4area17h8e4e7672f777df00E"(ptr align 4 %self) unnamed_addr #1 {
start:
  %_2 = load float, ptr %self, align 4, !noundef !4
  %0 = getelementptr inbounds i8, ptr %self, i64 4
  %_3 = load float, ptr %0, align 4, !noundef !4
  %_0 = fmul float %_2, %_3
  ret float %_0
}

; <main::Rect as main::IShape>::perimeter
; Function Attrs: uwtable
define internal float @"_ZN43_$LT$main..Rect$u20$as$u20$main..IShape$GT$9perimeter17hbbd2124028785f6fE"(ptr align 4 %self) unnamed_addr #1 {
start:
...
; <main::Square as main::IShape>::area
; Function Attrs: uwtable
define internal float @"_ZN45_$LT$main..Square$u20$as$u20$main..IShape$GT$4area17h1205a70ee985ee41E"(ptr align 4 %self) unnamed_addr #1 {
start:
  %_2 = load float, ptr %self, align 4, !noundef !4
  %_3 = load float, ptr %self, align 4, !noundef !4
  %_0 = fmul float %_2, %_3
...
; <main::Square as main::IShape>::perimeter
; Function Attrs: uwtable
define internal float @"_ZN45_$LT$main..Square$u20$as$u20$main..IShape$GT$9perimeter17h8b637d63b8b57af4E"(ptr align 4 %self) unnamed_addr #1 {
start:
  %_2 = load float, ptr %self, align 4, !noundef !4
  %_0 = fmul float 1.000000e+00, %_2
  ret float %_0
}

; main::print_area_perimeter
; Function Attrs: uwtable
define internal void @_ZN4main20print_area_perimeter17h9c728ea1d9ec0846E(ptr align 4 %t) unnamed_addr #1 {
start:
...
; call <main::Square as main::IShape>::area
  %0 = call float @"_ZN45_$LT$main..Square$u20$as$u20$main..IShape$GT$4area17h1205a70ee985ee41E"(ptr align 4 %t)
  store float %0, ptr %_10, align 4
  store ptr %_10, ptr %_0.i1, align 8
  %1 = getelementptr inbounds i8, ptr %_0.i1, i64 8
  store ptr @"_ZN4core3fmt5float50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$f32$GT$3fmt17h6b914598b35950d2E", ptr %1, align 8
  ...
  %7 = getelementptr inbounds [1 x %"core::fmt::rt::Argument<'_>"], ptr %_7, i64 0, i64 0
  store ptr %_8.0, ptr %7, align 8
  %8 = getelementptr inbounds i8, ptr %7, i64 8
  store ptr %_8.1, ptr %8, align 8
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h0320b5b43df3b70eE(ptr sret(%"core::fmt::Arguments<'_>") align 8 %_3, ptr align 8 @alloc_110d1bd43e86ee08011d1bd9cd3082dd, i64 2, ptr align 8 %_7, i64 1)
; call std::io::stdio::_print
  call void @_ZN3std2io5stdio6_print17h88dc1fea8555288bE(ptr align 8 %_3)
; call <main::Square as main::IShape>::perimeter
  %9 = call float @"_ZN45_$LT$main..Square$u20$as$u20$main..IShape$GT$9perimeter17h8b637d63b8b57af4E"(ptr align 4 %t)
  store float %9, ptr %_19, align 4
  store ptr %_19, ptr %_0.i, align 8
  %10 = getelementptr inbounds i8, ptr %_0.i, i64 8
  store ptr @"_ZN4core3fmt5float50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$f32$GT$3fmt17h6b914598b35950d2E", ptr %10, align 8
  %11 = load ptr, ptr %_0.i, align 8, !nonnull !4, !align !6, !noundef !4
  %12 = getelementptr inbounds i8, ptr %_0.i, i64 8
  ...
  %16 = getelementptr inbounds [1 x %"core::fmt::rt::Argument<'_>"], ptr %_16, i64 0, i64 0
  store ptr %_17.0, ptr %16, align 8
  %17 = getelementptr inbounds i8, ptr %16, i64 8
  store ptr %_17.1, ptr %17, align 8
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h0320b5b43df3b70eE(ptr sret(%"core::fmt::Arguments<'_>") align 8 %_12, ptr align 8 @alloc_513c709e935092212a5e01b086c380ac, i64 2, ptr align 8 %_16, i64 1)
; call std::io::stdio::_print
...
; main::print_area_perimeter
; Function Attrs: uwtable
define internal void @_ZN4main20print_area_perimeter17hb087485c8d74b2d5E(ptr align 4 %t) unnamed_addr #1 {
start:
  %_0.i1 = alloca %"core::fmt::rt::Argument<'_>", align 8
  %_0.i = alloca %"core::fmt::rt::Argument<'_>", align 8
  %_19 = alloca float, align 4
  ...
  %_7 = alloca [1 x %"core::fmt::rt::Argument<'_>"], align 8
  %_3 = alloca %"core::fmt::Arguments<'_>", align 8
; call <main::Rect as main::IShape>::area
  %0 = call float @"_ZN43_$LT$main..Rect$u20$as$u20$main..IShape$GT$4area17h8e4e7672f777df00E"(ptr align 4 %t)
  store float %0, ptr %_10, align 4
  store ptr %_10, ptr %_0.i1, align 8
  %1 = getelementptr inbounds i8, ptr %_0.i1, i64 8
  store ptr @"_ZN4core3fmt5float50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$f32$GT$3fmt17h6b914598b35950d2E", ptr %1, align 8
...
; call std::io::stdio::_print
  call void @_ZN3std2io5stdio6_print17h88dc1fea8555288bE(ptr align 8 %_3)
; call <main::Rect as main::IShape>::perimeter
  %9 = call float @"_ZN43_$LT$main..Rect$u20$as$u20$main..IShape$GT$9perimeter17hbbd2124028785f6fE"(ptr align 4 %t)
  store float %9, ptr %_19, align 4
  store ptr %_19, ptr %_0.i, align 8
  %10 = getelementptr inbounds i8, ptr %_0.i, i64 8
  store ptr @"_ZN4core3fmt5float50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$f32$GT$3fmt17h6b914598b35950d2E", ptr %10, align 8
...
; Function Attrs: uwtable
declare zeroext i1 @"_ZN4core3fmt5float50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$f32$GT$3fmt17h6b914598b35950d2E"(ptr align 4, ptr align 8) unnamed_addr #1
